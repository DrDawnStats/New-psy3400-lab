...
1. Data for NYC film permits was obtained from the NYC open data website. The .csv file can be found here: <a href="https://github.com/DrDawnStats/new_stats-lab/blob/main/data/Film_Permits.csv" download>Film_Permits.csv</a>


2. Gapminder data from the gapminder project (copied from the R gapminder library) can be downloaded in .csv format here: <a href="https://github.com/DrDawnStats/new_stats-lab/blob/main/data/gapminder.csv" download>gapminder.csv</a>
