...
Note the lab templates and data files in them are identical. The "desktop" folder has an additinal file which will be useful for the desktop but not for the cloud.

Watch this intro vidow for the labs using RStudioCloud:
