...
As we have found out from the textbook, when we measure things, we get lots of numbers. Too many. Sometimes so many your head explodes just thinking about them. One of **the most helpful things** you can do to begin to make sense of these numbers, is to look at them in graphical form. 
\
Unfortunately, for sight-impaired individuals, graphical summary of data is much more well-developed than other forms of summarizing data for our human senses. Some researchers are developing auditory versions of visual graphs, a process called **sonification**, but we aren't prepared to demonstrate that here. Instead, we will make charts, and plots, and things to look at, rather than the numbers themselves, mainly because these are tools that are easiest to get our hands on, they are the most developed, and they work really well for visual summary. 
...
1. Data for NYC film permits was obtained from the NYC open data website: <a href="https://opendata.cityofnewyork.us/" >NYC Open Data</a>  


2. Gapminder is an educational non-profit focusing on helping people avoid the common misconceptions often found on social media and other non-scientific sources. You should take some time to explore and learn from this group trying to improve our data literacy: <a href="https://www.gapminder.org/" >Gapminder: You are probably wrong about that!</a>

If you have not yet watched the video [8.5 minutes] showing the status of the UN's Sustainable Development Goals (SDG), please do so now. It should help you understand why data visualization is a key data literacy skill:

<iframe width="560" height="315" src="https://www.youtube.com/embed/v7WUpgPZzpI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

\
\
**The data for lab 1 is in the Lab zip folder you downloaded in section 0.2.1 above, but you will find more download links in each of the module lab instructions below.**

## R 

### Download the lab folders

You will be completing each lab by writing your code and notes in an R Markdown document. 

1. Download the [Lab_files.zip](hhttps://www.dropbox.com/s/z3uhu05bn0btye6/Lab_files.zip?dl=0) to your computer. Note this link is to a Dropbox folder where you can download the Zip file. You do not have to have a Dropbox account or sign in to Dropbox. 

2. Unzip the folder. There are two zipped folders inside. One, RStudioLabCloud.zip is to be used if you are using RStudio Cloud. The other, RStudioLabDesktop.zip is to be used if you are using RStudio on your desktop.


Note the lab templates and data files in them are identical. The "desktop" folder has an additional file which will be useful for the desktop but not for the cloud.

<iframe width="560" height="315" src="https://www.youtube.com/embed/52WlazGlTM4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

Watch this intro video for the labs using RStudioCloud:

\ 

<iframe width="560" height="315" src="https://www.youtube.com/embed/11w2lGVBt6I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
\ 
...
\
We also wrote down the steps [here](https://crumplab.github.io/statisticsLab/software.html#how-to-complete-the-r-labs).
...
**Note that when you hover your cursor over the code, a clipboard icon appears on the right side.** Just click on that icon to copy the code. Then you can paste it in your lab document in RStudio.
...
If you are having issues getting the data loaded, reach out to your instructor because you will be downloading and analyzing all kinds of data files this term. 

### Look at the data

We will follow the very same steps every time. The steps are to load the data, then look at it. You want to see what you've got.
