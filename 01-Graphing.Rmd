...
**Note that when you hover your cursor over the code, a clipboard icon appears on the right side.** Just click on that icon to copy the code. Then you can paste it in your lab document.
