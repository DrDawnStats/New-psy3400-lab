...
This lab manual is an adaption from the PSYCH 3400 Lab Manual authored by Matt Crump, Anjali Krishnan, Stephen Volz, and Alla Chavarga. 
...
You will need to download and install both R and RStudio. Although you can go to the R Project website and install R from there, you can also go directly to the RStudio webpage and get links to install both R and RStudio.
